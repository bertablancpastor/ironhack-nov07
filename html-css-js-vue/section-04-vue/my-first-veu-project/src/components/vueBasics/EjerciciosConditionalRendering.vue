...
<h1 v-if="display">I'm showing up beacuse our reactive data is true!</h1>
...
<div v-if="show"></div>
<h1>{{bio.name}}</h1>
<p v-if="bio.age > 18">I am and adult</p>
<p v-else>I'm still a young!</p>

<p v-if="bio.hasCodeBefore">This is not the first time!</p>
<p v-else>I am still a newbie to code but I'm learning</p>
</div>
