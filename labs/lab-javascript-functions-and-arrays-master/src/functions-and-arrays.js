...
console.log(`La suma de los numeros del ARRAY es: ${sumNumbers(numbers)}`);
...
console.log(`La suma del array numerico es ${sum(mixedArr)}`);
  


// Iteration #4: Calculate the average
// Level 1: Array of numbers
const numbersAvg = [2, 6.4, 9, 10.5, 7, 4.23, 1, 9];

function averageNumbers(numbersAvg) {
  return (sumNumbers(numbersAvg) / numbersAvg.length).toFixed(2)
}

console.log(`Avarage of the array is: ${averageNumbers(numbersAvg)}`);
...
function averageWordLength(wordsArr) {
 ...
 console.log(`Average of this words array is: ${averageWordLength(wordsArr)}`);
...
console.log(`La media seria de: ${avg(mixedArr2)}`);
